...
# num_filter_ens = [32, 32, 32] / num_filter_ens_2 = [4] / dataset_name = Fashion_MNIST or CIFAR10                                   
...
def main(): 
    ...
    if load_model: 
        ...
        classifier = Classifier(model, dataset_name, device, nb_classes, batch_size, input_shape, optimizer, criterion, seed) 
# model = vanilar neural network, dataset_name = Fashion-MNIST, device = CPU or GPU, nb_classes = class number(10) , batch_size = 100, input_shape = (1, 28, 28), optimizer = Adam, criteion = CrossEntropyLoss
